...
{
    [Serializable]
    public struct DataPacket1
    {
        private double _ew_corr;
        private double _eCodeTester;
        /*
                private double _eInDoor;
        */
        /*
                private double _CodeTesterRelHum;
        */
        // private double _absHum;
        /*
        ...
        */
        ...
        public double InDoorDbt { get => _InDoorDbt; }
        public double InDoorHum { get => _InDoorHum; }
        public double InDoorWbt { get => _InDoorWbt; }
        public double OutDoorDbt { get => _OutDoorDbt; }
        public double OutDoorHum { get => _OutDoorHum; }
        public double OutDoorWbt { get => _OutDoorWbt; }
        ...
        public double CoolingCapacity { set; get; }
        //{
        ...
        public double AirFlowRate  // m^3/h
        {
            get
            {
                ...
                foreach (var noz in Program.Chamber.Sample.Nozzles)
                {
                    var _Cd = Cd(noz.Diameter, CodeTesterDbT);
                    m += noz.Enabled
                        ? _Y * _Cd * noz.Area * Math.Sqrt(2 * NozzlePress * Vn_(CodeTesterDbT, CodeTesterWbt, AtmosphericPress + StaticPress - NozzlePress)) : 0;//- NozzlePress
                }


                var _vda = Vda(CodeTesterDbT, CodeTesterWbt, AtmosphericPress + StaticPress - NozzlePress);//- NozzlePress
        ...
        {
            _ew_corr = 0.000644 * (AtmosphericPress + StaticPress) * (CodeTesterDbT - CodeTesterWbt);
            return _ew_corr;
        ...
        public void Calculate()
        {
            ...
            _eCodeTester = Pws(CodeTesterDbT);
